...
export const FULL_NAV: NavItem[] = [
  ...
  { id: "local-seo", label: "Local SEO / GMB", group: "2 · Growth", n: 8 },
  { id: "reputation", label: "Reputation & Reviews", group: "2 · Growth", n: 9 },
  ...
  { id: "cultural", label: "Cultural / Seasonal Calendar", group: "3 · Ops", n: 17 },
];
