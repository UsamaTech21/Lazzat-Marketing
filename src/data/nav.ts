...
/** Full strategy — Tools / Execution / Control / Pricing / Next Actions temporarily hidden */
export const FULL_NAV: NavItem[] = [
  ...
  { id: "funnel", label: "Customer Journey / Funnel", group: "2 · Growth", n: 7 },
  { id: "keywords", label: "Keyword Research", group: "2 · Growth", n: 8 },
  { id: "local-seo", label: "Local SEO / GMB", group: "2 · Growth", n: 9 },
  { id: "reputation", label: "Reputation & Reviews", group: "2 · Growth", n: 10 },
  { id: "organic", label: "Organic Marketing", group: "2 · Growth", n: 11 },
  { id: "influencer", label: "Influencer Marketing", group: "2 · Growth", n: 12 },
  { id: "paid", label: "Paid Marketing Plan", group: "2 · Growth", n: 13 },
  { id: "budget", label: "Budget & Resource Plan", group: "3 · Ops", n: 14 },
  { id: "timeline", label: "Timeline / Roadmap", group: "3 · Ops", n: 15 },
  { id: "kpis", label: "KPIs & Measurement", group: "3 · Ops", n: 16 },
  { id: "growth", label: "Growth Plan", group: "3 · Ops", n: 17 },
  { id: "cultural", label: "Cultural / Seasonal Calendar", group: "3 · Ops", n: 18 },
];
