...
export const culturalCalendar = [
  { month: "Apr", occasion: "Vaisakhi", dish: "Chicken skewers + Lamb seekh" },
  { month: "May/Jun", occasion: "Eid ul-Fitr", dish: "Biryani + Sajji" },
  { month: "Jun/Jul", occasion: "Eid ul-Adha", dish: "Lamb chops + seekh" },
  { month: "Jul/Aug", occasion: "Caribbean Carnival", dish: "Doner + wraps" },
  { month: "Sep/Oct", occasion: "Navratri", dish: "Paneer tikka" },
  { month: "Oct/Nov", occasion: "Diwali", dish: "Family platter" },
  { month: "Dec", occasion: "Holiday feast", dish: "Sajji + desserts" },
];
